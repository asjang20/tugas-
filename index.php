...
<?php
            ...
            <form action="" method ="POST">
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" readonly=""class="form-control" id="nim" name="nim" value="<?php echo $nim?>">
        </div>
    </div>
    ...
    <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" readonly=""class="form-control" id="alamat" name="alamat" value="<?php echo $alamat?>">
        </div>
    </div>
